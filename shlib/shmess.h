...
int subData(char* data,uint8_t* fonction);
...
int getServerResponse(EthernetClient* cli,char* data,int lmax,uint8_t* fonction);
#endif // PERIF
...
int getServerResponse(WiFiClient* cli,char* data,int lmax,uint8_t* fonction);
#endif // PERIF
