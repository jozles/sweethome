...
void printConstant()
{
  ...
  for(int i=0;i<NBSW;i++){
    ...
    Serial.print((cstRec.intCde>>((i+1)*2))&0x01);Serial.print("   ");Serial.print(cstRec.pulseMode[i],HEX);Serial.print(" ");Serial.print(cstRec.intOPulse[i]);Serial.print(" ");Serial.println(cstRec.intIPulse[i]);
